...
def route_guardrail(state: AgentState) -> Literal["synthesize", "reject"]:
    """
...
def synthesize_response_agent(state: AgentState) -> dict:
    """
    ...
    return {"messages": messages + [SystemMessage(content=response)]}
